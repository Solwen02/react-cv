...
const Portfolio = () => {
    ...
    return (
        <section className="portfolio">
            <article>
                <figure>
                    <img src="/public/images/img_1.jpg" alt="" />
            ...
            <article>
                <figure>
                    <img src="/public/images/img_3.jpg" alt="" />
                    <figcaption>Projet 03</figcaption>
                </figure>
            </article>
            <article>
                <figure><img src="/public/images/img_4.jpg" alt="" />
                    <figcaption>Projet 04</figcaption>
                </figure>
            </article>
            <article>
                <figure>
                    <img src="/public/images/img_5.jpg" alt="" />
                    <figcaption>Projet 05</figcaption>
                </figure>
            </article>
            <article>
                <figure>
                    <img src="/public/images/img_6.jpg" alt="" />
                    <figcaption>Projet 06</figcaption>
                </figure>
            </article>
            <article>
                <figure>
                    <img src="/public/images/img_7.jpg" alt="" />
                    <figcaption>Projet 07</figcaption>
                </figure>
            </article>
            <article>
                <figure><img src="/public/images/img_8.jpg" alt="" />
                    <figcaption>Projet 08</figcaption>
                </figure>
            </article>
            <article>
                <figure>
                    <img src="/public/images/img_9.jpg" alt="" />
